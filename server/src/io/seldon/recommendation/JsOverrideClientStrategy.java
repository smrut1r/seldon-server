...
public class JsOverrideClientStrategy implements ClientStrategy {
    ...
    static {
        ...
        oldAlgNamesToNew.put("USER_BASED", "mahoutUBRecommender");
        ...
        oldAlgNamesToNew.put("ASSOC_RULE", "assocRuleRecommender");
    ...
    public AlgorithmStrategy getAlgorithmStrategy(List<AlgorithmStrategy> strategies, String strategy) {
        for(AlgorithmStrategy bas : strategies){
            if(bas.name.equals(strategy)){
                return bas;
            }
        }
        return null;
    ...
    public List<AlgorithmStrategy> getAlgorithms(String userId, String recTag) {
        ...
        for(String override : overrideAlgs){
            ...
            AlgorithmStrategy strategy = getAlgorithmStrategy(baseAlgStrats, name);
